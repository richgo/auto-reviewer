...
This will:
1. Find all skill/eval pairs in `skills/concerns/*.md` ↔ `evals/*.json`
...
python scripts/tune/autoresearch.py \
  --skill skills/concerns/concurrency.md \
...
- Ensure skills are in `skills/concerns/` subdirectory
...
## Related
- `skill-optimizer.md` — Tune individual skills
