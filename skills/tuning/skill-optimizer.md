...
# 3. Review changes
git diff skills/concerns/security-injection.md
...
git add skills/concerns/security-injection.md
...
## Related
- `benchmark-runner.md` — Compare skills across models
- `local-calibration.md` — Adapt skills to repo-specific conventions
