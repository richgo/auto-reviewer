...
## Purpose
Threads continuously changing state in response to each other without making progress.
...
```
**Expected finding:** Medium — Threads continuously changing state in response to each other without making progress....
