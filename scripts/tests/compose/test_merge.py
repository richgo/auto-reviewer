...
class TestComposeMerge(unittest.TestCase):
    def test_merge_managed_dependencies_preserves_non_managed_sections(self):
                ...
                yaml.safe_dump(
                    {
                        ...
                        "dependencies": {
                            "apm": [
                                ...
                                "richgo/auto-reviewer/skills/core/review-orchestrator#v0.9.0",
                            ]
                        },
        ...
        self.assertIn("richgo/auto-reviewer/skills/core/diff-analysis#v1.0.0", merged["dependencies"]["apm"])
