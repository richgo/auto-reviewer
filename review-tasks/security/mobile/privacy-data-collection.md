# Task: Mobile Privacy Data Collection
...
## Description
Excessive permissions, tracking without consent, clipboard snooping, background location without justification.
...
```
**Expected finding:** Medium — Excessive permissions, tracking without consent, clipboard snooping, background ... Implement proper security controls.
